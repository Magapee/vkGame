...
class LiteDB():
    ...
    def insert_new(self, user_id):
        message = """INSERT INTO users VALUES ( """ + str(user_id) + """, """ + const.begin_gold + """, """ + const.beging_exp + """, """ + const.begin_lvl +  """, """ + const.begin_country +  """, """ + """NULL""" +  """, """ + const.begin_win +  """, """ + const.begin_state +  """, """ + const.begin_atk +  """, """ + const.begin_health + """ )"""
